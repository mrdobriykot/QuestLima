...
<div class="container">
    ...
    <jsp:useBean id="user" scope="session" type="com.javarush.mokropolov.entity.User"/>
    <jsp:useBean id="question" scope="request" type="com.javarush.mokropolov.entity.Question"/>
    <jsp:useBean id="game" scope="request" type="com.javarush.mokropolov.entity.Game"/>
