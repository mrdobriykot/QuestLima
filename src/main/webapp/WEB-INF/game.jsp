...
<div class="container">
  ...
  <jsp:useBean id="user" scope="session" type="com.javarush.quest.torkel.entity.User"/>
  <jsp:useBean id="question" scope="request" type="com.javarush.quest.torkel.entity.Question"/>
  <jsp:useBean id="game" scope="request" type="com.javarush.quest.torkel.entity.Game"/>
  ...
  <div class="px-3 py-3 my-3 text-left">
    ...
    <h1>${question.text}</h1>
    <form action="game?id=${game.id}" method="post">
      <ul>
