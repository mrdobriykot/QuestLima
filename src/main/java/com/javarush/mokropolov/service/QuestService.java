...
import com.javarush.mokropolov.entity.*;
import com.javarush.mokropolov.repository.AnswerRepository;
import com.javarush.mokropolov.repository.QuestRepository;
...
public class QuestService {
    ...
    private Long findStartQuestionLabel(String text) {
        ...
        throw new RuntimeException("not found start index in text");
