...
public enum UserService {
    ...
    public User createOrModifyUser(String login, String password, User userOrNull) {
        ...
        if (userOrNull == null) {
            newUser = getUser(login, password, null);
        } else {
            newUser = getUser(login, password, userOrNull);
        }
    ...
    private User getUser(String login, String password, User userOrNull) {
        User newUser;
        ...
        if (userOrNull == null) {
            ...
            newUser = getUserBuild(login, password);
        } else {
            ...
            newUser = getUserBuild(login, password, userOrNull.getRole(), userOrNull);
        }
        return newUser;
    }
    ...
    private User getUserBuild(String login, String password) {
        return User.builder()
                .login(login)
                .password(password)
                .role(Roles.USER)
